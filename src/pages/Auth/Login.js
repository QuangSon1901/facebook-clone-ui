...
const Login = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            email_phone: Yup.string()
                ...
                .required('Bạn cần thêm thông tin này khi đăng nhập tài khoản'),
            password: Yup.string()
                .min(6, 'Nhập mật khẩu có tối thiểu là 6 ký tự.')
                .required('Nhập mật khẩu có tối thiểu là 6 ký tự.'),
        }),
        onSubmit: (values) => {
            console.log(values);
        },
    ...
    return (
        <div className="auth__login">
                    ...
                    <div className="auth__login__header__container__right">
                        <div className="auth__login__header__container__right__body">
                            <form onSubmit={formik.handleSubmit}>
                                ...
                                <div className="auth__login__header__container__right__body__form-group">
                                    <Button
                                        className="auth__login__header__container__right__body__form-group__register-btn"
            ...
            {openModal && <Register onClose={() => setOpenModal(false)} />}
            <Footer />
        </div>
    );
};
